...
const t: HomeT = {
  ...
  pricing: {
    ...
    tiers: [
      {
        tier: '§ Quick-Setup',
        h3: 'Door opener. Creditable.',
        desc: `Owner-operator, small team, hands-on? 2–5 days together — set up the platform, first flows live, code in your repo. Afterwards you run alone, or come back.`,
        num: '8–15k',
        unit: '€',
        sub: '2–5 days · creditable against later setup',
        list: [
          'Set up the platform with you',
          '1–2 first flows live',
          'Code in your repo',
          'Diagnose-Mode onboarding for your team',
          'Direct line to me',
        ],
      },
      {
        tier: '§ Standard',
        h3: 'Operational platform with license.',
        desc: 'Cloud-hosted. Up to ~50 flows, 10 integrated systems, 5 power users on your team.',
        num: '15–50k',
        unit: '€ Setup',
        sub: '+ 2–5k / month license',
        list: [
          'Setup sprint 1–3 weeks',
          'Platform license: updates, bug fixes, Diagnose-Mode',
          'Cloud-hosted (StackIT EU or your hoster)',
          'Half-yearly or quarterly review included',
      ...
      },
      {
        ...
        list: [
          'Setup sprint 3–9 weeks',
          'Multi-tenant · multi-site · hybrid deploy',
          'Quarterly review included',
          'On-premise · air-gap-capable on request',
          'Code in your repo · source code escrow optional',
        ],
      },
    ],
    addons: [
      {
        tier: '§ Resources',
        h3: 'Passed through 1:1. 10% admin.',
        desc: 'Compute, storage, AI tokens. You pay market price from StackIT/Anthropic/etc. plus 10% admin. No volume markup, no margin trick. Prepaid, monthly statement with receipts.',
      },
      {
        tier: '§ Architect day',
        h3: 'Bookable on demand.',
