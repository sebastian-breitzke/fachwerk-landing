...
const t = {
  ...
  pricing: {
    ...
    tiers: [
      {
        tier: '§ Quick-Setup',
        h3: 'Türöffner. Anrechenbar.',
        desc: 'Owner-Operator, kleines Team, viel Hands-on? 2–5 Tage gemeinsam — Plattform aufsetzen, erste Flows live, Code in deinem Repo. Danach läufst du allein, oder kommst zurück.',
        num: '8–15k',
        unit: '€',
        sub: '2–5 Tage · anrechenbar auf späteres Setup',
        list: [
          'Plattform aufsetzen mit dir',
          '1–2 erste Flows live',
          'Code in deinem Repo',
          'Diagnose-Mode-Onboarding für dein Team',
          'Direkter Draht zu mir',
        ],
      },
      {
        tier: '§ Standard',
        h3: 'Operative Plattform mit Lizenz.',
        desc: 'Cloud-gehostet. Bis ~50 Flows, 10 integrierte Systeme, 5 Power-User in deinem Team.',
        num: '15–50k',
        unit: '€ Setup',
        sub: '+ 2–5k / Monat Lizenz',
        list: [
          'Setup-Sprint 1–3 Wochen',
          'Plattform-Lizenz: Updates, Bug-Fixes, Diagnose-Mode',
          'Cloud-gehostet (StackIT EU oder dein Hoster)',
          'Halbjahres- oder Quartals-Review im Preis',
      ...
      },
      {
        ...
        list: [
          'Setup-Sprint 3–9 Wochen',
          'Multi-Mandant · Multi-Standort · Hybrid-Deploy',
          'Quartals-Review im Preis',
          'On-Premise · Air-Gap-fähig auf Anfrage',
          'Code in deinem Repo · Quellcode-Escrow optional',
        ],
      },
    ],
    addons: [
      {
        tier: '§ Resources',
        h3: '1:1 durchgereicht. 10% Admin.',
        desc: 'Compute, Storage, AI-Tokens. Du zahlst Marktpreis von StackIT/Anthropic/etc. plus 10% Verwaltung. Keine Volumen-Aufschläge, kein Markup. Vorkasse, monatliche Abrechnung mit Belegen.',
      },
      {
        tier: '§ Architektur-Tag',
        h3: 'Buchbar nach Bedarf.',
