...
const t = {
  ...
  ai: {
    ...
    lede: `Eine "Standard-SAP-Schnittstelle"? In 20 Jahren nie gesehen. Eine "Shopify-Anbindung"? Technisch ja — aber was du tatsächlich brauchst (Retouren-Codes mappen, Mandanten-Kontext einrechnen, deine Listing-Logik) ist immer Custom. Genau hier scheitert Low-Code im Mittelstand. Genau hier hast du Consultants, die jahrelang konfigurieren.<br><br><strong>Fachwerks Hebel: KI schreibt jede Integration custom für dich.</strong> One-Shot bei Standard-APIs (Shopify, GraphQL, SAP-RFC, DATEV-Connect) — die KI kennt sie aus den Trainingsdaten. Deep bei Obskurem (Modbus über 30-Jahre-alten TCP-Stack auf deiner SPS) — die KI liest die Doku, kennt die Low-Level-Traps, schreibt produktionsreifen Code wo Senior-Devs nur noch JSON sprechen. Du zahlst nicht für Adapter. Du zahlst für die Plattform und die Zeit, die wir reinstecken, dass dein Code für deinen Fall passt.`,
